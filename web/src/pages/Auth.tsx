...
import { requestCode, verifyCode, importSessionString } from '../api/auth'
                        ...
                        <div className="p-6 rounded-2xl bg-[var(--color-bg-panel)] border border-[var(--color-border)]">
                            ...
                            <div className="flex justify-center py-6">
                                <div className="w-48 h-48 bg-white rounded-2xl p-4 flex items-center justify-center">
                                    {/* Placeholder QR - In reality this would be generated by the backend */}
                                    <div className="w-full h-full bg-[url('data:image/svg+xml;base64,')] bg-contain bg-center bg-no-repeat rounded-lg border-4 border-[var(--color-accent)]">
                                        <QrCode className="w-full h-full text-gray-800 p-4" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="p-6 rounded-2xl bg-[var(--color-bg-panel)] border border-[var(--color-border)]">
                            ...
                            <div className="space-y-4">
                                <label className="flex flex-col items-center justify-center py-10 px-6 rounded-xl border-2 border-dashed border-[var(--color-border)] hover:border-[var(--color-accent)] transition-colors cursor-pointer bg-[var(--color-bg-elevated)]/50">
                                    ...
                                    <input type="file" accept=".session" className="hidden" />
                                </label>
