        ...
        <div className="relative">
            ...
            >
                ...
                <span className="text-sm text-[var(--color-text-primary)]">
                    {isLoading ? 'Loading...' : (activeSession?.username ? `@${activeSession.username}` : activeSession?.name || 'No Account')}
                </span>
                            ...
                            >
                                ...
                                <div className="flex-1 text-left">
                                    ...
                                    <div className="text-xs text-[var(--color-text-muted)]">
                                        {session.username ? `@${session.username}` : session.phone || 'No username'}
                                    </div>
                                </div>
                                {session.is_active && (
